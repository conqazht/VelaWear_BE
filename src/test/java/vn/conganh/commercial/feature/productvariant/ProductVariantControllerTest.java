...
@Transactional
@DisplayName("Module Product Variant - ProductVariantController")
class ProductVariantControllerTest extends AuthenticatedIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        testDataFactory.seedPermissions("PRODUCTVARIANT", BASE_PATH, "GET", "POST");
        testDataFactory.seedPermissions("PRODUCTVARIANT", BASE_PATH + "/{id}", "DELETE", "GET", "PUT");
    ...
    private static final String BASE_PATH = "/api/v1/product-variants";
    private static final String TABLE_NAME = "product_variants";
