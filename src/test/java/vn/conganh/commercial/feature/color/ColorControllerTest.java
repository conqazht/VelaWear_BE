...
class ColorControllerTest extends AuthenticatedIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        testDataFactory.seedPermissions("COLOR", BASE_PATH, "GET", "POST");
        testDataFactory.seedPermissions("COLOR", BASE_PATH + "/{id}", "DELETE", "GET", "PUT");
    ...
    private static final String BASE_PATH = "/api/v1/colors";
    private static final String TABLE_NAME = "colors";
    private static final boolean SOFT_DELETE = false;
    private static final boolean HAS_UPDATED_AT = false;
