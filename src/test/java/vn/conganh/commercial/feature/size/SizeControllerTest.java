...
class SizeControllerTest extends AuthenticatedIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        testDataFactory.seedPermissions("SIZE", BASE_PATH, "GET", "POST");
        testDataFactory.seedPermissions("SIZE", BASE_PATH + "/{id}", "DELETE", "GET", "PUT");
    ...
    private static final String BASE_PATH = "/api/v1/sizes";
