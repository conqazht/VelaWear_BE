...
class PermissionControllerTest extends AuthenticatedIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        testDataFactory.seedPermissions("PERMISSION", BASE_PATH, "GET", "POST");
        testDataFactory.seedPermissions("PERMISSION", BASE_PATH + "/{id}", "DELETE", "GET", "PUT");
