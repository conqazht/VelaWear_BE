...
class WishlistControllerTest extends AuthenticatedIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        testDataFactory.seedPermissions("WISHLIST", BASE_PATH, "GET", "POST");
        testDataFactory.seedPermissions("WISHLIST", BASE_PATH + "/{id}", "DELETE", "GET");
    ...
    private static final String BASE_PATH = "/api/v1/wishlists";
    private static final String TABLE_NAME = "wishlists";
