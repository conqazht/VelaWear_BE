...
class RoleControllerTest extends AuthenticatedIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        testDataFactory.seedPermissions("ROLE", BASE_PATH, "GET", "POST");
        testDataFactory.seedPermissions("ROLE", BASE_PATH + "/{id}", "DELETE", "GET", "PUT");
